...
public class ExpenseDto implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.getValue(), getValue()) == 0 && Objects.equals(getId(), that.getId()) && Objects.equals(getDescription(), that.getDescription()) && Objects.equals(getUser(), that.getUser()) && Objects.equals(getExpense_type(), that.getExpense_type());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getDescription(), getValue(), getUser(), getExpense_type());
    }
}
