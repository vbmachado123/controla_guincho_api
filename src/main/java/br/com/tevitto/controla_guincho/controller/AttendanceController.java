...
//        service.createAttendance(dto);
    ...
    @Operation(summary = "download a image")
    @GetMapping("/download/{path}")
    public ResponseEntity<Resource> download(@PathVariable String path, HttpServletRequest request) throws IOException {

        Resource resource = service.downloadImage(path);
